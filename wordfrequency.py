...
def find_most_frequent(frequency_table):
    ...
    list_of_items = frequency_table.keys()
    greatest = -1
    key_of_greatest = None
    for item in list_of_items:
        if frequency_table[item] > greatest:
            key_of_greatest = item
            greatest = frequency_table[item]
    
    return key_of_greatest  # TODO: Du må erstatte denne linjen
